  ...
  return (
    <>
      ...
      <section className="px-6 py-10 ll2:px-14.5 ll2:pt-24.5 ll2:pb-36.5 3xl:px-24.5 3xl:pt-[130px] 3xl:pb-[200px]">
        <img src="https://i.imgur.com/FCD67NT.jpeg" alt="about img" className="h-[200px] ll:h-[350px] ll2:h-[450px] 3xl:h-[600px] w-full object-cover rounded-xl 3xl:rounded-16" />

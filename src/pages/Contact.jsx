...
import CommonHero from "../components/CommonHero"; // Common hero section component
import { contactsCirdData } from "../Data/contactsCirdData"; // Contact info data array
    ...
    <>
      ...
      <div className="mt-12.5 3xl:mt-20">
        <iframe
          ...
          style={{ border: 0 }}
          allowFullScreen="" // Allows fullscreen map view
          loading="lazy" // Improves performance by loading map only when visible
          referrerPolicy="no-referrer-when-downgrade"
          className="w-full h-[400px] 3xl:h-[550px]" // Responsive height
        />
      </div>
    </>
  );
